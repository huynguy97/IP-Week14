...
{
//               
    assert ( A <= size(songs) && B <= size(songs) );
/*                 
                                                                              */
...
void quicksort_1 (vector<Track>& songs, int first, int last)
{
//                
    assert (0 <= first && last < size(songs));
/*                 
    ...
    {
        int red, blue;
        dnf_1(songs, first, last, red, blue);
        quicksort_1(songs, first, red);
        quicksort_1(songs, blue, last);
    }
}
...
int main()
{
    ...
    quicksort_1(songs, 0, size(songs) - 1);
